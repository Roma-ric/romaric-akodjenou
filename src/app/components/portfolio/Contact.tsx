  ...
  const contactMethods = [
    {
      ...
      contact: "romaricakodjenou54@gmail.com",
      icon: (
        ...
        <section className="w-full">
          <div className="pb-12 mx-auto w-full">
            <div>
              ...
              <p className="mt-3 text-gray-500 dark:text-gray-400">I’d love to hear from you. Please fill out this form or shoot me an email.</p>
            </div>

            <div className="flex scr_2_1:flex-col scr_1_2:space-x-24 scr_2_1:space-x-0 justify-around mt-10 items-center">
              ...
              <div className="p-4 py-6 scr_3_1:w-full bg-black/[0.8] dark:bg-white/[0.1] border rounded-lg bg-gray-50 dark:bg-gray-800">
                ...
                <form className=''>
                  ...
                  <div className="mt-4">
                    ...
                    <input type="email" placeholder="adress@example.com" className="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring-yellow-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                  </div>
