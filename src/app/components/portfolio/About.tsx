...
const About = () => {
    ...
    //                 link.href = url;
    //                 link.setAttribute('download', 'CV-ROMARIC-AKODJENOU');
    ...
    return (
        <div className="relative min-h-screen border-b dark:border-b-stone-800  py-16 bg-transparent flex flex-col md:flex-row overflow-hidden md:pb-16" id='about'>
            ...
            <div className='w-[80%] flex justify-center items-center mx-auto mt-10'>
                ...
                <div className='flex flex-col text-xl'>
                    ...
                    <div className="w-full flex mt-3 space-x-3">
                        {/* Facebook */}
                        <div className="p-2 bg-white bg-opacity-15 text-yellow-500 rounded-full">
                    ...
                    <Link href="/cv/CV.pdf" target="_blank" className='lg:mx-auto mt-5'>
                        <div className="inline-flex items-center text-lg text-black dark:text-white rounded-full bg-transparent border-2 border-yellow-500 bg-yellow-500 bg-opacity-55 hover:bg-opacity-70 transition-colors duration-300 cursor-pointer px-6 lg:px-4 lg:py-2 py-2">
                ...
                <div className='w-[70%] mt-10 mx-auto'>
                    <div className="grid grid-cols-4 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl">
                        ...
                        <SkillCard
                            ...
                            logo={
                                <svg className="w-12 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor">
                                    <path d="M223.961 172.008c-40.52 0-73.088 32.512-73.088 73.008s32.544 73.008 73.088 73.008c40.56 0 73.12-32.512 73.12-73.008s-32.56-73.008-73.12-73.008zm-57.712-101.024C110.328 108.96 76.776 177.744 76.776 244.384c0 6.464.336 12.848 1.008 19.136h-.624c-2.096 0-4.16.16-6.24.336C30.168 275.264 0 312.96 0 357.6v58.368c0 35.04 28.592 63.632 63.632 63.632H255.68c35.04 0 63.632-28.592 63.632-63.632V357.6c0-43.136-28.224-79.872-67.104-92.72 1.904-6.656 2.896-13.6 2.896-20.784 0-81.76-64.72-189.568-88.832-189.568-.432.016-.768 8-24 15.456h.976zm88.848 312.992c0 17.584-14.304 31.872-31.872 31.872H63.648c-17.568 0-31.872-14.304-31.872-31.872V357.6c0-17.568 14.304-31.872 31.872-31.872h159.392c-17.744 11.424-29.44 31.168-29.44 53.744 0 35.04 28.592 63.632 63.632 63.632h.416v10.88h-.432zm-95.072-95.072c-17.584 0-31.872-14.304-31.872-31.872s14.304-31.872 31.872-31.872c17.584 0 31.872 14.304 31.872 31.872s-14.304 31.872-31.872 31.872zm63.952-137.136c-31.184 0-56.512 25.328-56.512 56.512 0 31.184 25.328 56.512 56.512 56.512S224 269.552 224 238.368c.016-31.184-25.312-56.512-56.496-56.512z" />
                                </svg>
                            }
                        />
