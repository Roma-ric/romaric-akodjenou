        ...
        <div className="w-full flex mt-3 space-x-3">
            {
                social?.map((item, index) => (
                    <a key={index} href={item?.link} target="_blank">
                        <div className="p-2 w-10 h-10 flex justify-center items-center bg-foreground text-background brutal-border brutal-shadow-sm brutal-interactive rounded-none">
                            {item?.svg}
                        </div>
                    </a>
                ))
