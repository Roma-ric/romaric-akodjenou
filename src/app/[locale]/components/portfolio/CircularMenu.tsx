...
const CircularMenu = ({
  ...
  useEffect(() => {
    ...
    if (!document.getElementById("glow-filter")) {
      ...
      feColorMatrix.setAttribute(
        "values",
        "0.92 0 0 0 0  0 0.7 0 0 0  0 0 0.03 0 0  0 0 0 18 -7"
      );
    ...
    if (
      ...
      !document.getElementById(menuId.current)
    ) {
      ...
      const emitParticle = () => {
        if (!containerRef.current || !document.getElementById(menuId.current))
          return;
  ...
  return (
    <div
      className="fixed z-50 bottom-7 left-1/2 scr_3:block hidden -translate-x-1/2"
      ref={containerRef}
                    ...
                    <motion.div
                      ...
                      onClick={() => {
                        if (containerRef.current) {
                          ...
                          ripple.style.left = `${
                            getCircularMenuItemPosition(i).x + 6
                          }px`;
                          ripple.style.top = `${
                            getCircularMenuItemPosition(i).y + 6
                          }px`;
